...
- Trotz auskömmlicher Bilanz haben **21 der 47 Standorte** eine Lücke: Die Plätze liegen
  dort, wo die Kinder weniger werden.
...
| **Szenarien** | „Stufenplan Regelfall“, „Ausbaupfad 400“, „Elternquote 90“, dazu freie Regler | Kosten je Platz, Träger- und Personalkapazitäten sind nicht öffentlich |
...
## Die eine Annahme — offen benannt
...
| [Bericht über Angaben der Stadt Bochum, 18.05.2026](https://www.radiobochum.de/artikel/mehr-ogs-plaetze-an-grundschulen-in-bochum-2651761) | stadtweite OGS-Eckwerte 2026/27: 8.397 Plätze, 292 Ablehnungen, 27 von 49 Schulen voll versorgt | HTML; jeder Wert wird beim Abruf im Quelltext nachgewiesen |
...
```bash
python3 scripts/fetch_grundschulbezirke.py  # Kartendienst → bo_grundschulbezirke.json
